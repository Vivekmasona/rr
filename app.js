...
ytproDownDiv.innerHTML+="<span style='position:absolute;top:15px;left:15px;color:#04C5B9;font-size:30px;' onclick='"+"this.parentElement.parentElement.style.display="+'"'+"none"+'"'+";'>&#x2715;</span><iframe  sandbox='allow-downloads allow-forms allow-modals allow-pointer-lock allow-presentation allow-same-origin allow-scripts allow-top-navigation-by-user-activation'  scrolling='no' src='https://loader.to/api/button/?url=ytproURL'></iframe> <ul id='listurl'>";
...
ytproDownVidElem.innerHTML='	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#04C5B9" viewBox="0 0 24 24"><path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"/></svg>								<br><font color=#00cdb8><b>PG  DOWNLOAD';
...
ytproPIPVidElem.innerHTML='	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"   fill="#04C5B9" viewBox="0 0 24 24"><path d="M19 7h-8v6h8V7zm2-4H3c-1.1 0-2 .9-2 2v14c0 1.1.9 1.98 2 1.98h18c1.1 0 2-.88 2-1.98V5c0-1.1-.9-2-2-2zm0 16.01H3V4.98h18v14.03z"/></svg>								<br><font color=#00cdb8><b>PG  POPUP ';
...
ytproAudDivElem.style.borderTop="0px solid #04C5B9";
ytproAudX.style.borderTop="0px solid #04C5B9";
ytproAudX.style.borderRight="0px solid #04C5B9";
ytproAudX.style.position="absolute";
